...
- [x] `pnpm smoke` prints readable checklist to terminal
- [x] Checklist covers all manual-only test scenarios
- [x] Epic 4 features included (errors, preview, protected pages)
- [x] Publishing checklist references the smoke command
