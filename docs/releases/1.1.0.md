# MarkQuote 1.1.0 Release Notes

## Overview

Version 1.1.0 focuses on clipboard reliability, test coverage, and selection
...
- [x] `package.json` and `public/manifest.json` both read `1.1.0`
...
1. Tag release: `git tag v1.1.0 && git push origin v1.1.0`
2. Publish to Chrome Web Store
3. Merge `release/1.1.0` back to `main`
