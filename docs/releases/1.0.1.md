# MarkQuote 1.0.1 Release Notes

## Overview

Version 1.0.1 is a patch release focusing on clipboard reliability and selection
...
- [x] `package.json` and `public/manifest.json` both read `1.0.1`
...
1. Tag release: `git tag v1.0.1 && git push origin v1.0.1`
2. Publish to Chrome Web Store
3. Merge `release/1.0.1` back to `main`
