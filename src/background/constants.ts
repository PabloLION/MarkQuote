...
export const E2E_GET_CLIPBOARD_PAYLOAD_MESSAGE = "e2e:get-clipboard-payload";
export const E2E_RECORD_CLIPBOARD_PAYLOAD_MESSAGE = "e2e:record-clipboard-payload";
export const E2E_SET_CLIPBOARD_TAG_MESSAGE = "e2e:set-clipboard-tag";
export const E2E_GET_CLIPBOARD_TELEMETRY_MESSAGE = "e2e:get-clipboard-telemetry";
export const E2E_CLEAR_CLIPBOARD_TELEMETRY_MESSAGE = "e2e:clear-clipboard-telemetry";
